  ...
  return {
    home: {
      ...
      players: {
        ...
        'Mason Plumlee': { number: 4, shoe: 19, points: 26, rebounds: 12, assists: 6, steals: 3, blocks: 8, slamDunks: 5 },
        'Jason Terry': { number: 5, shoe: 15, points: 19, rebounds: 2, assists: 2, steals: 4, blocks: 11, slamDunks: 1 },
      }
    },
    away: {
